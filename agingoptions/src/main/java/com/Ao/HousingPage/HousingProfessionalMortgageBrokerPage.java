...
public class HousingProfessionalMortgageBrokerPage extends HousingProfessionalMortgageBrokerPageOr {

	
     public WebUtil wt;
    
    public HousingProfessionalMortgageBrokerPage(WebUtil util) {
    	super(util);
		this.wt=util;
    ...
    public void IdoNotHaveMortgageFunctionality() {
    ...
    public void ClickIdoNotHaveMortgage() {
    	wt.click(HousingProfessionalButton, "Housing Professional button");
    	wt.holdOn(Duration.ofSeconds(4));
    	wt.click(MortgageBrokerSection, "Mortgage Broker Secton");
    	wt.holdOn(Duration.ofSeconds(5));
	...
	public void verifytoggleButton() {
	 ...
	 public void GoToMortgaePageOnHousingInfo() {
		 wt.click(HousingProfessionalButton, "Housing professional Button");
