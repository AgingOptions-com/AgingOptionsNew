...
public class PersonalMedicalHistory {
	...
	public void primaryMemberDidYouGrowUpTextStatus() {
		util.isDisplayed(primaryMemberDidYouGrowUpSmokingText,
				"Primary Member Did you grow up in a smoking household or work in a smoking environment?");
	}
	...
	public void spouseDidYouGrowUpTextStatus() {
		util.isDisplayed(spouseDidYouGrowUpSmokingText,
				"Spouse Did you grow up in a smoking household or work in a smoking environment?");
	}
	...
	public void primaryMemberDoYouHaveConditionTextStatus() {
		util.isDisplayed(primaryMemberDoYouHaveConditionText,
				"Primary Member Do you have conditions that limit physical ability?");
	}
	...
	public void primaryMemberDoYouhaveDifficultyTextStatus() {
		util.isDisplayed(primaryMemberDoYouhaveDifficultyText,
				"Primary Member Do you have difficulty with gait, balance, or ambulation?");
	}
	...
	public void spouseDoYouHaveDifficultyTextStatus() {
		util.isDisplayed(spouseDoYouhaveDifficultyText,
				"Spouse Do you have difficulty with gait, balance, or ambulation?");
	}
	...
	public void selectAreYouAllergicYesRadioButtonPrimaryMember() {
		util.selectRadioButton(primaryMemberAreYouAllergicToAnyMedicationYesRadioButton,
				"primary member Are you allergic to any medications? Yes Radio Button");
	}

	public void deSelectAreYouAllergicYesRadioButtonPrimaryMember() {
		util.deselectRadioButton(primaryMemberAreYouAllergicToAnyMedicationYesRadioButton,
				"primary member Are you allergic to any medications? Yes Radio Button");
	}
	...
	public void selectAreYouAllergicYesRadioButtonSpouse() {
		util.selectRadioButton(spouseAreYouAllergicToAnyMedicationYesRadioButton,
				"spouse Are you allergic to any medications? Yes Radio Button");
	}

	public void deSelectAreYouAllergicYesRadioButtonSpouse() {
		util.deselectRadioButton(spouseAreYouAllergicToAnyMedicationYesRadioButton,
				"Spouse Are you allergic to any medications? Yes Radio Button");
	}
	...
	// util.sendValue(didYouGrowUpCommentTB, didYouGrowUpText, "Did you grow up in a
	// smoking household or work in a smoking environment?");
	// }
	...
	public void sendPrimaryMemberDidYouGrowUpCommentText(String primaryMemberdidYouGrowUp) {
		util.sendValue(primaryMemberDidYouGrowUpCommentTB, primaryMemberdidYouGrowUp,
				"Primary Member Did you grow up comment");
	}
	...
	public void clickPrimaryMemberDoYouHaveConditionYesRadioButton() {
		util.click(primaryMemberDoYouHaveConditionYesRadioButton,
				"Primary Member Do you have conditions that limit physical ability?");
	}
	...
	public void clickspouseDoYouHaveConditionYesRadioButton() {
		util.click(spouseDoYouHaveConditionYesRadioButton,
				"Spouse Do you have conditions that limit physical ability?");
	}
	...
	public void sendPrimaryMemberDoYouHaveConditionCommentTextBox(String primaryMemberDoYouHaveCondition) {
		util.sendValue(primaryMemberDoYouHaveConditionCommentTB, primaryMemberDoYouHaveCondition,
				"primary Member Do you have conditions that limit physical ability?");
	}
	...
	public void sendSpouseDoYouHaveConditionCommentTextBox(String primaryMemberDoYouHaveCondition) {
		util.sendValue(spouseDoYouHaveConditionCommentTB, primaryMemberDoYouHaveCondition,
				"Spouse Do you have conditions that limit physical ability?");
	}
	...
	public void clickPrimaryMemberYesRadioButtonDoYouDiffcultyWithGait() {
		util.click(primaryMemberDoYouDifficultyYesRadioBT,
				"Primary Member Do you Have Difficulty with gait Radio Button");
	}
	...
	public void sendPrimaryMemberDoYouHaveDifficultyGaitCommentText(String comment) {
		util.sendValue(primaryMemberDoYouHaveDifficultyGaitCommentTB, comment,
				"Primary Member Do you have difficulty with gait, balance, or ambulation?");
	}
	...
	public void sendSpouseDoYouHaveDifficultyGaitCommentText(String comment) {
		util.sendValue(spouseDoYouHaveDifficultyGaitCommentTB, comment,
				"Primary Member Do you have difficulty with gait, balance, or ambulation?");
	}
